...
namespace Microsoft.Extensions.DependencyInjection
{
    public static partial class ServiceCollectionExtensions
    {
        ...
        private static IServiceCollection AddElasticsearchCore(this IServiceCollection services)
        {
            ...
            services.TryAddSingleton(serviceProvider => serviceProvider.GetRequiredService<IGlasssixElasticClientFactory>().Create());

            services.TryAddSingleton<IElasticClientFactory, DefaultElasticClientFactory>();
            services.TryAddSingleton<IGlasssixElasticClientFactory, DefaultGlasssixElasticClientFactory>();
