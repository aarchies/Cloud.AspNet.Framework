...
using Glasssix.Contrib.Repository.Queries.Criteria;
...
namespace Glasssix.Contrib.Repository.Queries
{
    ...
    public class Query<TEntity> : Query<TEntity, string>, IQuery<TEntity> where TEntity : class
    {
        /// <summary>
        /// 初始化查询对象
        /// </summary>
        ...
        public Query(IQueryParameters queryParam) : base(queryParam)
        {
        }
    }
    ...
    public class Query<TEntity, TKey> : IQuery<TEntity, TKey> where TEntity : class
    {
        ...
        /// 查询参数
        /// </summary>
        private readonly IQueryParameters _parameter;
        ...
        /// 初始化查询对象
        /// </summary>
        public Query() : this(new QueryParameters())
        {
        }
        ...
        public Query(IQueryParameters parameter)
        {
        ...
        {
            return new Pager(_parameter.Page, _parameter.PageSize, _parameter.Total, GetOrder());
        }
        ...
        public IQuery<TEntity, TKey> Or(params Expression<Func<TEntity, bool>>[] predicates)
        {
            ...
            {
                var predicate = QueryHelper.GetWhereIfNotEmptyExpression(item);
                if (predicate == null)
                    continue;
        ...
        {
            predicate = QueryHelper.GetWhereIfNotEmptyExpression(predicate);
            if (predicate == null)
                return this;
            return And(predicate);
        }
