...
using Glasssix.Contrib.Data.Storage.Prometheus.Extensions;
using Glasssix.Contrib.Data.Storage.Prometheus.Model.Reponse;
...
{
    internal class GlasssixPrometheusClient : IGlasssixPrometheusClient
    {
        ...
        public GlasssixPrometheusClient(HttpClient client, JsonSerializerOptions jsonSerializerOptions, ILogger<GlasssixPrometheusClient> logger)
        {
            _client = client;
