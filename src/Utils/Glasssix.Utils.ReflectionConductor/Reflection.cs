...
using TypeExtensions = Extensions.TypeTools;

namespace Glasssix.Utils.ReflectionConductor
{
    /// <summary>
    /// 反射操作
    /// </summary>
    public static class Reflection
    {
        ...
        {
            return GetDescription(TypeExtensions.GetType<T>());
        }
        ...
        {
            return GetDescription(TypeExtensions.GetType<T>(), memberName);
        }
        ...
        {
            return GetDisplayName(TypeExtensions.GetType<T>());
        }
        ...
        {
            return TypeExtensions.GetType<T>().GetDisplayNameOrDescription();
        }
        ...
        private static List<Type> GetTypes(Type findType, Assembly assembly)
        {
            ...
            try
            {
                if (assembly.FullName.Contains("MySql.EntityFrameworkCore") || assembly.FullName.Contains("System.DirectoryServices.Protocols"))
                    return result;
