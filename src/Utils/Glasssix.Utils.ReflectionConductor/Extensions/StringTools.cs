...
namespace Extensions
{
    public static class StringTools
    {
        ...
        {
            return ObjectTools.ToGuidOrNull(obj);
        }
        ...
        {
            return ObjectTools.ToIntOrNull(obj);
        }
        ...
        {
            return ObjectTools.ToLongOrNull(obj);
        }
