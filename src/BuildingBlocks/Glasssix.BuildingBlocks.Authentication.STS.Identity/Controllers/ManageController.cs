...
using Glasssix.BuildingBlocks.Authentication.STS.Identity.Helpers.Localization;
using Glasssix.BuildingBlocks.Authentication.STS.Identity.ViewModels.Manage;
...
namespace Glasssix.BuildingBlocks.Authentication.STS.Identity.Controllers
{
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("IdentityAuthServer.STS.Identity"),
