using IdentityAuthServer.STS.Identity.Configuration;
using IdentityAuthServer.STS.Identity.Configuration.ApplicationParts;
using IdentityAuthServer.STS.Identity.Configuration.Constants;
using IdentityAuthServer.STS.Identity.Configuration.Interfaces;
using IdentityAuthServer.STS.Identity.Helpers.Localization;
...
namespace IdentityAuthServer.STS.Identity.Helpers
{
