using IdentityAuthServer.Admin.Api.Configuration;
using IdentityAuthServer.Admin.Api.Configuration.ApplicationParts;
using IdentityAuthServer.Admin.Api.Configuration.AuditLogging;
using IdentityAuthServer.Admin.Api.Configuration.Constants;
using IdentityAuthServer.Admin.Api.Helpers.Localization;
using IdentityModel;
...
namespace IdentityAuthServer.Admin.Api.Helpers
{
